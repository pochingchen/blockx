...
func NewRandomBlock(t *testing.T, height uint64, prevBlockHash types.Hash) *core.Block {
...
func NewRandomBlockWithSignature(t *testing.T, pk crypto.PrivateKey, height uint64, prevHash types.Hash) *core.Block {
